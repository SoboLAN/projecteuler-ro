...
<ul>
	<li>Primul lucru care trebuie să-l faceți e să descărcați script-ul propriu zis de aici: <a href="projecteuler.translate.user.js"><b>Descarcă script</b></a>. (click dreapta și alegeți &quot;Save as / Save Link as&quot;)
		<br />
		Acest script este momentan la versiunea <strong>1.4</strong> și a fost actualizat ultima oară în <strong>24 Mai 2014</strong>.</li>
...
TamperMonkey (pentru Google Chrome) și multe altele. Multe script-uri folosesc funcții din familia GM_*. Aceste funcții fac parte din API-ul GreaseMonkey-ului. Prin urmare, ele pot fi folosite doar împreună cu GreaseMonkey. Acest script nu folosește nici o funcție din această familie și, prin urmare, poate fi folosit
pe orice browser (+ extensie) care suportă așa ceva. Dacă descoperiți că funcționează în Opera, de exemplu, atunci folosiți-l așa.</p>
